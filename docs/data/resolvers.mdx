...
>
> You can also [switch to the v2 docs](./v2).
...
[Apollo Studio](/studio/) integrates directly with Apollo Server to provide field-level metrics that help you understand the performance of your graph over time. For more information, see [Analyzing performance](/studio/performance/).
