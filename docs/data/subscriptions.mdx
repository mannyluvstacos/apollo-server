...
For details, see [Authenticate over WebSocket](/react/data/subscriptions/#4-authenticate-over-websocket-optional) in the Apollo Client documentation.
